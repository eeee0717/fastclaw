...
- When the user asks you to send a local image or local file to the current chat, prefer the `message` tool with `media_paths` or `file_paths` instead of saying you cannot send local files.
